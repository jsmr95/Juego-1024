...
function reduceColumna1Izquierda(){
    var c1 = document.getElementById('col41');
    var c2 = document.getElementById('col31');
...
function reduceColumna2Izquierda(){
    var c1 = document.getElementById('col42');
    var c2 = document.getElementById('col32');
    var c3 = document.getElementById('col22');
    var c4 = document.getElementById('col12');
    var columnas = [c4,c3,c2,c1];
    llenos = actualizaLlenos(columnas);
    //1º OPCION -> Solo hay uno lleno, se mueve a la derecha del todo
    if (llenos.length == 1) {
...
function reduceColumna3Izquierda(){
    var c1 = document.getElementById('col43');
    var c2 = document.getElementById('col33');
    var c3 = document.getElementById('col23');
    var c4 = document.getElementById('col13');
    var columnas = [c4,c3,c2,c1];
    llenos = actualizaLlenos(columnas);
    //1º OPCION -> Solo hay uno lleno, se mueve a la derecha del todo
    if (llenos.length == 1) {
...
function reduceColumna4Izquierda(){
    var c1 = document.getElementById('col44');
    var c2 = document.getElementById('col34');
    var c3 = document.getElementById('col24');
